...
public class AutomationService {
  ...
  public static String solveCaptcha(WebDriver driver) {
    try {
      ...
      BufferedImage resized =
          new BufferedImage(
              gray.getWidth() * 2, gray.getHeight() * 2, BufferedImage.TYPE_BYTE_GRAY);
  ...
  public static void clickCheckboxIfNeeded(WebDriver driver, WebDriverWait wait, String value) {
    ...
    try {
      By checkboxLocator = By.xpath("//input[@name='columnsMenuItem' and @value='" + value + "']");
  ...
  public static String runAutomation(
      WebDriver driver, String username, String password, String url, String type) {
    ...
    try {
      switch (type) {
        case "partner_fiberish":
          ...
          String apiUrl =
              url
                  + "/Ajax_Request/get_users_json?draw=3&columns[0][data]=user_full_name&columns[1][data]=address&columns[2][data]=package_name&columns[3][data]=seller_name&columns[5][data]=user_expiry_view&start=0&length=500&status=0";
          ...
          for (int i = 0; i < data.length(); i++) {
            ...
            String expiry =
                row.optString("user_expiry_view", "").replaceAll("<.*?>", ""); // remove HTML
        ...
        case "cp_fiberish":
          ...
          String[] targetFiles2 = {
            "Fiberish Broadband Billing Systems.xlsx", "Fiberish Broadband  Billing Systems.xlsx"
          };
          ...
          ((JavascriptExecutor) driver)
              .executeScript("arguments[0].scrollIntoView(true);", excelBtn);
          Thread.sleep(1000);
          ...
          while (waitTime2 < 40) {
            ...
            if (files != null) {
              for (File f : files) {
                if (f.getName().contains("Fiberish Broadband Billing Systems")
        ...
        case "sky_net":
          ...
          try {
            ...
            List<WebElement> closeBtns =
                driver.findElements(By.xpath("//button[contains(@class,'p-dialog-header-close')]"));
          ...
          WebElement columnMenuBtn =
              wait3.until(
                  ExpectedConditions.elementToBeClickable(
                      By.xpath(
                          "//a[contains(@class,'ng-tns-c60') and .//i[contains(@class,'fa-list')]]")));
          ...
          while (hasNextPage) {
            ...
            try {
              WebElement nextBtn =
                  driver.findElement(By.xpath("//a[@aria-label='Next']/parent::li"));
        ...
        case "connect":
          ...
          try {
            ...
            driver
                .findElement(By.cssSelector("input[type='password'].form-control"))
                .sendKeys(password);
          ...
          try {
            ...
            wait4.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//table")));
            ...
            List<WebElement> userLinks =
                driver.findElements(By.xpath("//a[contains(@href,'user-list')]"));
            ...
            // 📊 Wait for table
            wait4.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//tbody/tr")));
        ...
        case "national":
          ...
          for (int attempt = 1; attempt <= maxAttempts; attempt++) {
            ...
            wait5
                .until(ExpectedConditions.visibilityOfElementLocated(By.id("loginform-username")))
                .sendKeys(username);
            ...
            try {
              WebElement captchaErrorElement =
                  driver.findElement(
          ...
          try {
            ...
            ((JavascriptExecutor) driver).executeScript("arguments[0].click();", customersMenu);
          }
        ...
        case "daddy_sas":
          ...
          try {
            ...
            WebElement checkbox8 = firstRow.findElement(By.xpath(".//input[@type='checkbox']"));

            // scroll into view (IMPORTANT for MUI)
            ((JavascriptExecutor) driver)
                .executeScript("arguments[0].scrollIntoView(true);", checkbox8);
          ...
          try {
            WebElement downloadOption8 =
                wait8.until(
                    ExpectedConditions.elementToBeClickable(
                        By.xpath(
                            "//div[contains(@class,'box_utils')]//div[contains(@class,'item')]")));
        ...
        case "turbo_zong":
          ...
          try {
            ...
            wait9.until(ExpectedConditions.elementToBeClickable(By.id("signin"))).click();
        ...
        case "galaxy":
          ...
          try {
            ...
            ((JavascriptExecutor) driver)
                .executeScript("arguments[0].scrollIntoView(true);", firstRow);
            Thread.sleep(500);
            ...
            try {
              ...
              WebElement menu =
                  wait10.until(
                      ExpectedConditions.visibilityOfElementLocated(
                          By.xpath(
                              "//div[contains(@class,'p-menu-overlay') and contains(@class,'ng-star-inserted')]")));

              // ✅ Target the clickable <a> inside menu
              WebElement downloadBtn =
                  menu.findElement(By.xpath(".//span[normalize-space()='Download']/ancestor::a"));

              // scroll (safety)
              ((JavascriptExecutor) driver)
                  .executeScript("arguments[0].scrollIntoView({block:'center'});", downloadBtn);
        ...
        case "optix":
          ...
          try {
            ...
            WebElement loginBtnOptix =
                waitOptix.until(ExpectedConditions.elementToBeClickable(By.id("send")));
            loginBtnOptix.click();
        ...
        case "billing_galaxy":
          ...
          try {
            wait15
                .until(ExpectedConditions.visibilityOfElementLocated(By.id("signInFormUEP")))
                .sendKeys(username);
          ...
          wait15.until(
              d -> d.findElements(By.cssSelector("#customers_table tbody tr")).size() > 50);
          ...
          try {
            WebElement excelOption =
                wait15.until(
                    ExpectedConditions.elementToBeClickable(
                        By.xpath(
                            "//li[contains(@class,'buttons-excel')]//a[contains(text(),'Excel')]")));
          ...
          try {
            ...
            for (int i = 2; i <= sheet15.getLastRowNum(); i++) {
              ...
              String statusRaw = String.valueOf(getCellValue(sheet15, i, 7)).trim().toUpperCase();
        ...
        case "jazz_ftth":
          ...
          for (int attempt = 1; attempt <= maxAttempts16; attempt++) {
            ...
            try {
              ...
              wait16
                  .until(ExpectedConditions.visibilityOfElementLocated(By.id("user_login")))
                  .sendKeys(username);
              ...
              String sumValue =
                  wait16
                      .until(ExpectedConditions.presenceOfElementLocated(By.id("sum")))
                      .getAttribute("value");
              ...
              ((JavascriptExecutor) driver)
                  .executeScript("arguments[0].dispatchEvent(new Event('keyup'));", captchaInput);

              // 🔘 Wait until button enabled then click
              loginBtn =
                  wait16.until(ExpectedConditions.presenceOfElementLocated(By.id("login_btn")));

              wait16.until(driver1 -> driver1.findElement(By.id("login_btn")).isEnabled());
          ...
          try {
            ...
            try {
              ...
              wait16.until(
                  driver1 -> {
                    String html1 =
                        driver1.findElement(By.xpath("//tbody")).getAttribute("innerHTML");
                    try {
                      Thread.sleep(500);
            ...
            // ⏳ Wait for rows
            wait16.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//tbody/tr")));
              ...
              try {
                ...
                try {
                  WebElement statusElement =
                      cols.get(1).findElement(By.xpath(".//span[contains(@class,'left')]"));
        ...
        case "connect1":
          try {
            ...
            String fromDate66 =
                now66.withDayOfMonth(1).format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
            String toDate66 =
                now66
                    .withDayOfMonth(now66.lengthOfMonth())
            ...
            WebElement dateRangeInput66 =
                waitForClickable(driver, wait66, By.name("daterange"), "Date Range Input");
            ...
            WebElement searchBtn66 =
                waitForClickable(
                    ...
                    "Search Button");
            ((JavascriptExecutor) driver)
                .executeScript("arguments[0].scrollIntoView(true);", searchBtn66);
            ...
            java.util.List<WebElement> rows66 =
            ...
            for (WebElement row : rows66) {
              ...
              if (cols.size() < 6) {
                throw new RuntimeException(
                    "UI CHANGE DETECTED: Table structure changed. Expected >=6 columns but found "
                        + cols.size());
              }
  ...
  private static WebElement waitForElement(
      WebDriver driver, WebDriverWait wait, By locator, String elementName) {
    try {
      return wait.until(ExpectedConditions.visibilityOfElementLocated(locator));
    } catch (TimeoutException e) {
      throw new RuntimeException(
          "UI CHANGE DETECTED: Element not found -> " + elementName + " | Locator: " + locator);
    }
  }

  private static WebElement waitForClickable(
      WebDriver driver, WebDriverWait wait, By locator, String elementName) {
    try {
      return wait.until(ExpectedConditions.elementToBeClickable(locator));
    } catch (TimeoutException e) {
      throw new RuntimeException(
          "UI CHANGE DETECTED: Element not clickable -> " + elementName + " | Locator: " + locator);
    }
  }
}
